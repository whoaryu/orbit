...
const Cubes: React.FC<CubesProps> = ({
    ...
    (e: MouseEvent | TouchEvent) => {
      ...
      Object.keys(rings)
        ...
        .forEach(ring => {
          ...
          const prevColors = faces.map(face => window.getComputedStyle(face).backgroundColor);
  ...
  // Emerald → Blue palette for beauty
  ...
  const getCellColor = (row: number, col: number) => {
    const tRaw = (row + col) / Math.max(1, (gridSize - 1) * 2);
    const t = 0.5 - Math.cos(Math.PI * tRaw) / 2; // easeInOut
    return lerpColor(emerald, blue, t);
  };
  // Borders: solid black for each cube face

  return (
    <div className="relative w-11/12 max-md:w-11/12 aspect-square" style={wrapperStyle}>
            ...
            >
              ...
              <div
                ...
                style={{
                  ...
                  boxShadow: '0 10px 25px rgba(16,185,129,0.12), 0 6px 12px rgba(59,130,246,0.12)',
